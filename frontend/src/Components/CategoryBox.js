...
const CategoryBox = ({Img,Catergoy_name,_id}) => {
  return (
    ...
    <Link  to={`/Categories_products/${Catergoy_name}`} className=' relative bg-transparent h-[250px] w-[320px] text-xl transition-all ease-in-out duration-300 flex justify-center items-center overflow-hidden'>
